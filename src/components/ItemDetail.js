                ...
                <h2 className="w-100 ">Detalle del Producto</h2>
                    <div className="card w-100 shadow ">
                        <div>
                            ...
                            {(mostrarBotonFinalizar===true)?<ItemCount stock={producto.producto.stock} inicial={0} onAddItem={onAddItem}/>:<NavLink to="../carrito"><button className="btn btn-success p-3 justify-content-center">Ir al Carrito</button></NavLink>}
                        </div>
                    </div>
            </div>)}
        </div>
